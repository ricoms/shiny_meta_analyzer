...
server <- function(input, output) {
    ...
    fluidRow(
      column(width=12,
             box(title = tr("Model configuration"), width = 12, background = "orange",
                 ...
                 numericInput(
                  inputId = "alpha", 
                  label = tr("Level of significance"),
                  value = 0.05,
                  min = 0.00, 
                  max = 1,
                  step = 0.01
          ...
          fluidRow(
            column(6,
              conditionalPanel(
                ...
                selectInput(
                  ...
                  choices = c(
                    'exact binomial (Clopper-Pearson)'='CP',
                    'Wilson Score'='WS',
              ...
              conditionalPanel( # Correlacao
                ...
                selectInput(
                  ...
                  choices = c(
                    'Raw correlation coefficient'='COR',
            ...
            column(6,
              ...
              selectInput(
                ...
                choices = c(
                  'DerSimonian-Laird estimate (1986)' = 'DL',
                ...
                selected = "ML", width = 300, multiple = FALSE
              ),
  ...
  plotForest <- function(){
    ...
    if (!is.null(meta)) {
      ...
      } else { # if no effect model chosen
  ...
  plotFunnel <- function(){
    ...
    if (!is.null(meta)) {
      if (input$random_comb == TRUE || input$fixed_comb == TRUE) {
        ...
        if (1-pchisq(meta$Q, meta$df.Q) > alpha()) { # if p-value > alpha shows only fixed effect model
          funnel.meta(
            meta,
            studlab=paste(dados$data$Studies),
            comb.random=FALSE,
  ...
  # Permite realizar o download da figura Funnel
